...
public class TransactionView {
    ...
    static TransactionController tc = new TransactionController();
    JSONObject credentials = new JSONObject();

    public TransactionView(User user) {
        //displayTransactionView(user);
        System.out.println("Transaction under construction..." + user.getSignature_number() + " was here!");
    }
        ...
        while (true) {
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 1 -> ViewHelper.printOutObjValues(user);
